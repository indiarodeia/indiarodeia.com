                ...
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-24">
                    <div className="space-y-8">
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-6xl font-heading font-bold text-foreground">
                            {t.about.name1[lang]} <span className="text-accent-gradient">{t.about.name2[lang]}</span>
                        </h2>

                        {/* Portrait */}
                        <div className="relative w-40 h-40 sm:w-48 sm:h-48 md:w-56 md:h-56 rounded-2xl overflow-hidden border-2 border-accent/20">
                            <div
                                className="absolute inset-0 bg-gradient-to-br from-accent/10 via-transparent to-turquoise/10"
                                aria-hidden="true"
                            />
                            <img
                                src={portrait}
                        ...
                        <div className="rounded-2xl border border-border bg-background/60 backdrop-blur-sm p-6 sm:p-8">
                            <div className="grid grid-cols-3 gap-4 sm:gap-8">
                                <div className="text-center">
                                    <div className="text-2xl sm:text-3xl md:text-4xl font-heading font-bold text-accent">6+</div>
                                ...
                                <div className="text-center">
                                    ...
                                    <div className="text-xs sm:text-sm text-muted-foreground mt-1 sm:mt-2">
                                        {t.about.statsProjects[lang]}
                                    </div>
                                </div>
                                <div className="text-center">
                                    <div className="text-2xl sm:text-3xl md:text-4xl font-heading font-bold text-lavender">25+</div>
                                    <div className="text-xs sm:text-sm text-muted-foreground mt-1 sm:mt-2">
                                        {t.about.statsClients[lang]}
                                    </div>
                                </div>
                            </div>
                        </div>
